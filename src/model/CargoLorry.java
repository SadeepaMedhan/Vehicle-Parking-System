...
public class CargoLorry extends ObserverList implements Vehicle{
    ...
    public CargoLorry(String vehicleNumber, String vehicleType, int maximumWeight, int numberOfPassengers) {
